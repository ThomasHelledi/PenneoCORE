...
namespace Penneo
{
    ...
    public class RestConnector
    {
        ...
        /// </summary>
        public HttpResponseMessage InvokeRequest(string url, Dictionary<string, object> body = null, HttpMethod method = null, Dictionary<string, Dictionary<string, object>> options = null, string customMethod = null, int? page = null, int? perPage = null)
        {
            if (method == null)
