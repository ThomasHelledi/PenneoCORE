...
namespace Penneo.Connector
{
    ...
    internal interface IApiConnector
    {
        ...
        /// </summary>
        T ReadObject<T>(Entity parent, int? id, out HttpResponseMessage response)
            where T : Entity;
        ...
        /// </summary>
        T ReadObject<T>(Entity parent, int? id, string relativeUrl, out HttpResponseMessage response)
            where T : Entity;
        ...
        /// </summary>
        bool FindBy<T>(Dictionary<string, object> query, out IEnumerable<T> objects, out HttpResponseMessage response, int? page = null, int? perPage = null)
            where T : Entity;
        ...
        /// </summary>
        HttpResponseMessage CallServer(string url, Dictionary<string, object> data = null, HttpMethod method = null, Dictionary<string, Dictionary<string, object>> options = null, string customMethod = null, int? page = null, int? perPage = null);
    }
}